...
<?php require_once "partials/mainnav.view.php"?>
    <div class="wrapper1">
        ...
        <div class="questiontype">Вопрос второго типа (с несколькими ответами)</div>
        <div class="questiondiv2">
            <form action="/question2" method="post" enctype="multipart/form-data">
                ...
                <div class="wrapperanswer">
                    <div class="label"><label><span>Answer-1:</span> (correct <input type="checkbox" name="checkbox1" onclick="checkboxtwo(this)">) </label></div>
                    <div class="wrapperinput"><input type="text" name="answer1" class="input"></div>
                </div>
                <div class="wrapperanswer">
                    <div class="label"><label><span>Answer-2:</span> (correct <input type="checkbox" name="checkbox2" onclick="checkboxtwo(this)">) </label></div>
                    <div class="wrapperinput"><input type="text" class="input" name="answer2"></div>
                </div>
                <div class="wrapperanswer">
                    <div class="label"><label><span>Answer-3:</span> (correct <input type="checkbox" name="checkbox3" onclick="checkboxtwo(this)">) </label></div>
                    <div class="wrapperinput"><input type="text" class="input" name="answer3"></div>
                </div>
                <div class="wrapperanswer">
                    <div class="label"><label><span>Answer-4:</span> (correct <input type="checkbox" name="checkbox4" onclick="checkboxtwo(this)">) </label></div>
                    <div class="wrapperinput"><input type="text" class="input" name="answer4"></div>
                </div>
                <div class="wrapperanswer">
                    <div class="label"><label><span>Answer-5:</span> (correct <input type="checkbox" name="checkbox5" onclick="checkboxtwo(this)">) </label></div>
